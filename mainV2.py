...
if __name__ == "__main__":
    ...
    grid = grid.Grid(f"data/{district}/{district}_batteries.csv", 
    f"data/{district}/{district}_houses.csv")
 
    # -------------------------------- Prompt for algorithm ------------------------------
    all_algorithms = {"restricted_greedy": restricted_greedy(grid), 
    "hillclimber": hillclimber(grid), "shared_randomize" : randomize_shared(grid)}
